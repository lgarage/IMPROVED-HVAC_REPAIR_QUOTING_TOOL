...
- **Active phase:** None. Phases 31–32c shipped + KI-002 Plan A shipped 2026-04-25. Pick the next phase from `ROADMAP.md → Next Up` or continue KI-002 with Plan B subset (B1–B4).
- **Active blocker:** None.
- **Next phase candidates:** KI-002 Plan B subset (B1+B2+B3+B4) → C3 → E2; then Phase 33 — Field-Add Equipment.
